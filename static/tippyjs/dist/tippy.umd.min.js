!(function (e, t) {
  ...
  function R(e, t) {
    var n = Object.assign(
      ...
      t.ignoreAttributes
        ...
        : (function (e, t) {
            return (
              t ? Object.keys(k(Object.assign({}, L, { plugins: t }))) : D
            ).reduce(function (t, n) {
  ...
  function N(r, a) {
      ...
      X = {
        ...
        setProps: function (e) {
          ...
          var t = X.props,
            n = R(
              r,
              Object.assign({}, X.props, {}, e, { ignoreAttributes: !0 })
            );
          (X.props = n),
            me(),
        ...
        show: function () {
          ...
          if ((ie("onShow", [X], !1), !1 === X.props.onShow(X))) return;
          (X.state.isVisible = !0), Q() && ($.style.visibility = "visible");
          re(), fe(), X.state.isMounted || ($.style.transition = "none");
          if (Q()) {
            var s = te(),
              c = s.box,
              p = s.content;
              ...
              oe(),
                ...
                X.props.animation &&
                  ...
                  (function (e, t) {
                    ...
                    (X.state.isShown = !0), ie("onShown", [X]);
                  });
            }
          }),
            (function () {
              var e,
                ...
                n = Z();
              e =
                (X.props.interactive && t === L.appendTo) || "parent" === t
                  ? n.parentNode
                  : i(t, [n]);
        ...
        hide: function () {
          ...
          if (e || t || r) return;
          if ((ie("onHide", [X], !1), !1 === X.props.onHide(X))) return;
          (X.state.isVisible = !1),
            (X.state.isShown = !1),
            (N = !1),
            (M = !1),
    ...
    function oe() {
      ...
      if (e.content) {
        ...
        s(X.props.triggerTarget || r).forEach(function (e) {
          ...
          if (X.state.isVisible) e.setAttribute(t, r ? r + " " + n : n);
          else {
      ...
      void 0 === n && (n = !1),
        s(X.props.triggerTarget || r).forEach(function (r) {
          r.addEventListener(e, t, n),
            U.push({ node: r, eventType: e, handler: t, options: n });
        });
    }
    function me() {
      var e;
    ...
    function Oe() {
      ...
      Q() &&
        ...
        (X.popperInstance = e.createPopper(
          c,
          $,
          Object.assign({}, n, { placement: i, onFirstUpdate: C, modifiers: p })
        ));
    }
    function Te() {
      X.popperInstance &&
    ...
    function Ae(e) {
      if (
        (X.clearDelayTimeouts(), ie("onUntrigger", [X, e]), X.state.isVisible)
      ) {
        if (
          !(
            X.props.trigger.indexOf("mouseenter") >= 0 &&
    ...
    fn: function (e) {
      ...
      var n = V(e.popper),
        ...
        o = e.props.animateFill
          ? (function () {
              var e = f();
              return (e.className = "tippy-backdrop"), h([e], "hidden"), e;
            })()
          : null;
      return {
        onCreate: function () {
        ...
        onAfterUpdate: function (t, n) {
          ...
          r ||
            (void 0 !== o &&
              a.followCursor !== o &&
              (v(),
              o ? (l(), !e.state.isMounted || i || s() || u()) : (c(), p())));
        },
        onMount: function () {
          e.props.followCursor && !i && (o && (f(X), (o = !1)), s() || u());
        },
  ...
  return (
      ...
      var m = {
          fn: function () {
            return {
              ...
              onShow: function (e) {
                e.props.showOnCreate && !c && ((c = !0), v(e, o[0]));
              },
              onTrigger: function (e, t) {
                v(e, t.currentTarget);
              },
    ...
    (U.delegate = function (e, n) {
      ...
      function d(e) {
        if (e.target && !o) {
          ...
          if (t) {
            var r =
              t.getAttribute("data-tippy-trigger") || n.trigger || L.trigger;
            if (
              !t._tippy &&
              !(
                ("touchstart" === e.type && "boolean" == typeof f.touch) ||
                ("touchstart" !== e.type && r.indexOf(F[e.type]) < 0)
              )
            ) {
              var a = U(t, f);
              a && (i = i.concat(a));
    ...
    (U.hideAll = function (e) {
      ...
      H.forEach(function (e) {
        var t = !1;
        if ((n && (t = v(n) ? e.reference === n : e.popper === n.popper), !t)) {
